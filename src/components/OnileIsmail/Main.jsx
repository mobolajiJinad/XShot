      ...
      <div className="mb-10 mt-4 flex flex-wrap items-center justify-between sm:w-[55%]">
        <div>
          ...
          <p className="px-0 text-center text-sm sm:p-4 sm:text-left sm:text-base">
            ...
            contain the inspiration behind taking  potential client, it could contain the inspiration behind taking those pictures too.... i guess its allowed to take those pictures too....
          </p>
        </div>
